...
from .slice import _prepare_error_traj_slice_data
from typing import Union, Optional, Sequence, Tuple, Literal, Callable
from matplotlib.colors import Colormap

def compare_error_traj_frame_slice(
    ...
    **kwargs,
    ...
    Args:
        ...
        n_frames (int, optional): The number of frames to display in the animation. Defaults to 5.
        ...
        frame_start_index (int, optional): The starting index for the frames to display. Defaults to 0.
    """
    (
        fields,
        batch_names,
