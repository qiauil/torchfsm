...
class ETDRKIntegrator(Enum):
    ETDRK0 = {"integrator": ETDRK0, "nonlinear": False}
    ETDRK1 = {"integrator": ETDRK1, "nonlinear": True}
    ETDRK2 = {"integrator": ETDRK2, "nonlinear": True}
    ETDRK3 = {"integrator": ETDRK3, "nonlinear": True}
    ETDRK4 = {"integrator": ETDRK4, "nonlinear": True}